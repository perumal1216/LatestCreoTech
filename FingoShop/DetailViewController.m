...
-(void)callProductListServiceWithPage :(NSString *)CategoryId page:(NSUInteger)loadpage
{
   ...
   // NSString *sessionid=[[NSUserDefaults standardUserDefaults] objectForKey:@"sessionid"];
    NSString *url_str1=[NSString stringWithFormat:@"https://www.fingoshop.com/restconnect/api/getCategoryProductsList?id=%@",CategoryId];
    ...
    [NSURLConnection sendAsynchronousRequest:request queue:[NSOperationQueue mainQueue] completionHandler:^(NSURLResponse *response, NSData *data, NSError *error)
     {
         ...
         if (data)
         {
             ...
             NSString *nextURL=[[[jsonDict objectForKey:@"metadata"] objectForKey:@"links"] objectForKey:@"next"];

             nextURL=[nextURL stringByReplacingOccurrencesOfString:@" " withString:@"%20"];
             ...
             [NSURLConnection sendAsynchronousRequest:request queue:[NSOperationQueue mainQueue] completionHandler:^(NSURLResponse *response, NSData *data, NSError *error)
             {
                 ...
                 if (data)
                 {
                     ...
                     NSMutableArray *productsarr = [jsonDict objectForKey:@"records"];
