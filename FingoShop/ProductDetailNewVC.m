...
-(void)callAddToCartService:(NSString*)qty
{
    ...
    */
    ...
    NSDictionary *dict  = [NSDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults] objectForKey:@"customer_id"]],@"customerid",[NSString stringWithFormat:@"%@",[productDetailsDict objectForKey:@"id"]],@"product",@"1",@"qty",@"135",@"attributeid",selectedSize,@"optionid" ,nil];
