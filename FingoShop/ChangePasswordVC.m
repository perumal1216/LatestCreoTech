...
- (IBAction)changePasswordButtonAction:(id)sender {
   ...
   // Response - {"customerid":"649","oldpassword":"jumper123","newpassword":"jumper1234","change_status":1,"message":"Your Password has been Changed Successfully"}
    ...
    NSString *post=[NSString stringWithFormat:@"email=%@&old_password=%@&new_password=%@",emailid,_txt_oldPswd.text,_txt_newPswd.text];
    NSData *postData=[post dataUsingEncoding:NSUTF8StringEncoding allowLossyConversion:YES];
    NSString *postLength=[NSString stringWithFormat:@"%lu",(unsigned long)[postData length]];
    NSMutableURLRequest *request=[[NSMutableURLRequest alloc]initWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://www.fingoshop.com/restconnect/apicustomer/chnagepass"]]];
